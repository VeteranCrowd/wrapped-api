...
export class WrappedApi {
   ...
   * @return {WrappedApiError} {@link WrappedApiError} object.
   */
   ...
   * @return {WrappedApiResponse} {@link WrappedApiResponse} object.
   */
   ...
   * @return {Promise<WrappedApiResponse>} {@link WrappedApiResponse} object.
   */
   ...
   * @return {WrappedApi} {@link WrappedApi} instance for chaining.
   */
  init(config) {
